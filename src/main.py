...
if __name__ == '__main__':
    ...
    # found_sen_quantity, sen_total = similarity_filter.filt_similarity(
    #     data_dir_path + '/' + 'Batch 1' + '/' + 'test.xlsx',
    #     result_dir_path + '/' + 'Batch 1' + '/' + 'test' + '.txt')
    ...
    for batch_name in batchs:
        ...
        for language in batchs[batch_name]:
            ...
            # batch_rate[language] = str(evaluate[0]) + "/" + str(evaluate[1]) + " ~ " + str(evaluate[2]) + "%"
